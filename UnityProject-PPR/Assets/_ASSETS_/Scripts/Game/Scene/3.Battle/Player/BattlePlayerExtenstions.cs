...
{
    public static int GetAttackPoint(this BattlePlayer battlePlayer, List<GameBoardElement> elements, int plusPoint = 1)
    {
        int resultPoint = 0;
    ...
    public static int GetDefensePoint(this BattlePlayer battlePlayer, List<GameBoardElement> elements, int plusPoint = 1)
    {
        int resultPoint = 0;
